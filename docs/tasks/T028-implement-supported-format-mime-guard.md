---
id: T028
title: "Implement supported-format MIME guard"
...
Implement supported-format MIME guard in `lib/images/validate.ts` (maps to spec story US2)
...
- Source task: `T028` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: T037.
