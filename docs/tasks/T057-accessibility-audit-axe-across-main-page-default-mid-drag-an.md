---
id: T057
title: "Accessibility audit (axe) across main page (default + mid-drag) and album detail (populated/empty/lightbox-open) per quickstart.md"
...
Accessibility audit (axe) across main page (default + mid-drag) and album detail (populated/empty/lightbox-open) per `quickstart.md`
...
- Milestone: Phase 6: Polish & Cross-Cutting.
- Source task: `T057` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
