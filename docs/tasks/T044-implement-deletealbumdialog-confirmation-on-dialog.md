---
id: T044
title: "Implement DeleteAlbumDialog (confirmation) on Dialog"
...
Implement `DeleteAlbumDialog` (confirmation) on `Dialog` in `components/albums/DeleteAlbumDialog.tsx` (maps to spec story US2)
...
- `components/albums/DeleteAlbumDialog.tsx`
...
- Source task: `T044` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: T046.
