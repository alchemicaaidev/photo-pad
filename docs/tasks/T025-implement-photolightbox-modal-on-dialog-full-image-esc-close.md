---
id: T025
title: "Implement PhotoLightbox (modal on Dialog; full image; Esc closes; focus returns to originating tile)"
...
Implement `PhotoLightbox` (modal on `Dialog`; full image; Esc closes; focus returns to originating tile) in `components/photos/PhotoLightbox.tsx` (depends on T009, T014) (maps to spec story US1)
...
- Source task: `T025` in `specs/001-photo-album-organizer/tasks.md`.
...
- Dependencies (T009, T014) are complete or in review.
