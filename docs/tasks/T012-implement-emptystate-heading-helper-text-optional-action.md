---
id: T012
title: "Implement EmptyState (heading, helper text, optional action)"
...
Implement `EmptyState` (heading, helper text, optional action) in `components/ui/EmptyState.tsx` and unit test in `components/ui/EmptyState.test.tsx`
...
- Milestone: Phase 2: Foundational.
- Source task: `T012` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: T018, T023.
