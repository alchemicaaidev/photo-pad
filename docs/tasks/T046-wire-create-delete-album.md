---
id: T046
title: "Wire create + delete album"
milestone: "Phase 4: US2 Create Albums & Add Photos"
priority: 3
estimate: 3
blockedBy: [T036, T038, T040, T044]
blocks: []
areas:
  - app
parent: null
...
Wire create + delete album into main page in `app/page.tsx` (depends on T036, T038, T040, T044) (maps to spec story US2)
...
- Source task: `T046` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: T036, T038, T040, T044.
- Blocks: None.
- See `plan.md`, `data-model.md`, `research.md`, and `contracts/` for design detail.

## Definition of Ready

- Dependencies (T036, T038, T040, T044) are complete or in review.
