---
id: T007
title: "Unit test IndexedDB schema — stores, indexes, and (albumId, contentHash) unique constraint —"
...
Unit test IndexedDB schema — stores, indexes, and `(albumId, contentHash)` unique constraint — in `lib/db/schema.test.ts` (fake-indexeddb)
...
- Milestone: Phase 2: Foundational.
- Source task: `T007` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
