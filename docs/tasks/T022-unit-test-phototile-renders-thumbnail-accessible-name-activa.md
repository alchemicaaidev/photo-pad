---
id: T022
title: "Unit test PhotoTile (renders thumbnail, accessible name, activation; jest-axe)"
...
Unit test `PhotoTile` (renders thumbnail, accessible name, activation; jest-axe) in `components/photos/PhotoTile.test.tsx` (maps to spec story US1)
...
- `components/photos/PhotoTile.test.tsx`
...
- Source task: `T022` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
