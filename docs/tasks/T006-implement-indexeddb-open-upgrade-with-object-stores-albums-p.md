---
id: T006
title: "Implement IndexedDB open/upgrade with object stores albums, photos, photoBlobs and indexes by-position, by-album, by-album-order, unique by-album-hash"
...
Implement IndexedDB open/upgrade with object stores `albums`, `photos`, `photoBlobs` and indexes `by-position`, `by-album`, `by-album-order`, unique `by-album-hash` in `lib/db/schema.ts`
...
- Milestone: Phase 2: Foundational.
- Source task: `T006` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
