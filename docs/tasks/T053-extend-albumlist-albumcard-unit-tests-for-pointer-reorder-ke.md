---
id: T053
title: "Extend AlbumList/AlbumCard unit tests for pointer reorder, keyboard reorder, and cancel-to-origin"
...
Extend `AlbumList`/`AlbumCard` unit tests for pointer reorder, keyboard reorder, and cancel-to-origin in `components/albums/AlbumList.test.tsx` (maps to spec story US3)
...
- `components/albums/AlbumList.test.tsx`
...
- Source task: `T053` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
