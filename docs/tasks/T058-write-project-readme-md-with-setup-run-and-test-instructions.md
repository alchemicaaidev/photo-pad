---
id: T058
title: "Write project README.md with setup, run, and test instructions"
...
Write project `README.md` with setup, run, and test instructions
...
- Milestone: Phase 6: Polish & Cross-Cutting.
- Source task: `T058` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
