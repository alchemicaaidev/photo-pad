---
id: T029
title: "Unit test validate (accepts JPEG/PNG/GIF/WebP, rejects others)"
...
Unit test `validate` (accepts JPEG/PNG/GIF/WebP, rejects others) in `lib/images/validate.test.ts` (maps to spec story US2)
...
- Source task: `T029` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
