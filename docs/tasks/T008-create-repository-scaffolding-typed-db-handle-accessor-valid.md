---
id: T008
title: "Create repository scaffolding (typed db handle accessor, ValidationError/StorageError)"
...
Create repository scaffolding (typed db handle accessor, `ValidationError`/`StorageError`) in `lib/db/repository.ts`
...
- Milestone: Phase 2: Foundational.
- Source task: `T008` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
