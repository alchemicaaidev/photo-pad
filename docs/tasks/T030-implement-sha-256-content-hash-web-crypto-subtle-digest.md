---
id: T030
title: "Implement SHA-256 content hash (Web Crypto subtle.digest)"
...
Implement SHA-256 content hash (Web Crypto `subtle.digest`) in `lib/images/hash.ts` (maps to spec story US2)
...
- Source task: `T030` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: T037.
