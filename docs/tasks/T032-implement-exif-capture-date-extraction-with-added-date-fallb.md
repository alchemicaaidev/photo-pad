---
id: T032
title: "Implement EXIF capture-date extraction with added-date fallback (exifr)"
...
Implement EXIF capture-date extraction with added-date fallback (`exifr`) in `lib/images/exif.ts` (maps to spec story US2)
...
- Source task: `T032` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: T037.
