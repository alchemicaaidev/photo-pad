---
id: T055
title: "Add CI workflow running typecheck + lint + test as merge gates"
...
Add CI workflow running `typecheck` + `lint` + `test` as merge gates in `.github/workflows/ci.yml`
...
- Milestone: Phase 6: Polish & Cross-Cutting.
- Source task: `T055` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
