---
id: T013
title: "Implement root layout (html lang, skip-link, global styles)"
...
Implement root layout (html `lang`, skip-link, global styles) in `app/layout.tsx`
...
- Milestone: Phase 2: Foundational.
- Source task: `T013` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
