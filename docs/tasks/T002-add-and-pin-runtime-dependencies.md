---
id: T002
title: "Add and pin runtime dependencies"
...
Add and pin runtime dependencies in `package.json`: `idb`, `@dnd-kit/core`, `@dnd-kit/sortable`, `exifr`, `@tanstack/react-virtual`
...
- Milestone: Phase 1: Setup.
- Source task: `T002` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
