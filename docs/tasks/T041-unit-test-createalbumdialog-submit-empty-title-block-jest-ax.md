---
id: T041
title: "Unit test CreateAlbumDialog (submit, empty-title block, jest-axe)"
...
Unit test `CreateAlbumDialog` (submit, empty-title block, jest-axe) in `components/albums/CreateAlbumDialog.test.tsx` (maps to spec story US2)
...
- `components/albums/CreateAlbumDialog.test.tsx`
...
- Source task: `T041` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
