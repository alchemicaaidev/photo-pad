---
id: T009
title: "Implement shared Dialog primitive (focus trap, Esc close, role=\"dialog\" + aria-modal, labelled by title)"
...
Implement shared `Dialog` primitive (focus trap, Esc close, `role="dialog"` + `aria-modal`, labelled by title) in `components/ui/Dialog.tsx`
...
- Milestone: Phase 2: Foundational.
- Source task: `T009` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: T025.
