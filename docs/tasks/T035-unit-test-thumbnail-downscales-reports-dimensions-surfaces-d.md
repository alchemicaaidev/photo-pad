---
id: T035
title: "Unit test thumbnail (downscales; reports dimensions; surfaces decode failure)"
...
Unit test `thumbnail` (downscales; reports dimensions; surfaces decode failure) in `lib/images/thumbnail.test.ts` (maps to spec story US2)
...
- Source task: `T035` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
