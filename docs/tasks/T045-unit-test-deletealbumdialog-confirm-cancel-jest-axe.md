---
id: T045
title: "Unit test DeleteAlbumDialog (confirm/cancel, jest-axe)"
...
Unit test `DeleteAlbumDialog` (confirm/cancel, jest-axe) in `components/albums/DeleteAlbumDialog.test.tsx` (maps to spec story US2)
...
- `components/albums/DeleteAlbumDialog.test.tsx`
...
- Source task: `T045` in `specs/001-photo-album-organizer/tasks.md`.
- Depends on: None.
- Blocks: None.
